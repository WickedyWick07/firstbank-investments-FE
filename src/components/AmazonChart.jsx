...
const AMZNChart = () => {
  ...
  const url = `https://api.polygon.io/v2/aggs/ticker/AMZN/range/1/day/${startDate}/${endDate}?adjusted=true&sort=asc&limit=5000&apiKey=${apiKey}`;
  ...
  if (loading) return <p>Loading data for AMZN...</p>;
